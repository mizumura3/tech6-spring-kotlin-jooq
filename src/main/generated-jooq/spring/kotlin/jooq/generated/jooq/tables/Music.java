...
public class Music extends TableImpl<MusicRecord> {
    ...
    private static final long serialVersionUID = -82627911;
    ...
    /**
     * The column <code>music.artist_id</code>. アーティストID
     */
    public final TableField<MusicRecord, Integer> ARTIST_ID = createField("artist_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "アーティストID");
