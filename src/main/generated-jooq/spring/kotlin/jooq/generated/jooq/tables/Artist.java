...
public class Artist extends TableImpl<ArtistRecord> {
    ...
    private static final long serialVersionUID = -742344282;
    ...
    /**
     * The column <code>artist.name</code>. 名前
     */
    public final TableField<ArtistRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "名前");
